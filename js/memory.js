...
;(function( window ) {
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameMetaHTML = '<div class="mg__meta--left">\
      ...
      <button id="mg__button--restart" class="mg__button">Recomeçar</button>\
      </div>';
    ...
    this.game.appendChild(this.gameMeta);
      ...
      '<center><img src="img/default/monsters-08.png" alt="Imaginary" margin-bottom:20px";></center>\
      <h2 class="mg__start-screen--heading">Bem vindo ao nosso jogo da memória!</h2>\
      <p class="mg__start-screen--text">Gire os cartões e tente encontrar os pares correspondentes. Use a menor quantidade de movimentos possiveis e finalize o jogo.</p>\
      <h3 class="mg__start-screen--sub-heading">Selecione o level</h3>\
      <ul class="mg__start-screen--level-select">\
      <li ><span data-level="1">Level 1 - Fácil (4 x 2)</span></li>\
      <!-- <li><span data-level="2">Level 2 - Normal (6 x 3)</span></li>\
      <li><span data-level="3">Level 3 - Difícil (8 x 4)</span></li> -->\
      </ul>';
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      ...
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">Parabéns!</h2>\
        <p class="mg__onend--message">Você ganhou essa partida com ' + this.numMoves + ' jogadas.</p>\
        <button id="mg__onend--restart" class="mg__button">Jogar outra vez!</button>';
